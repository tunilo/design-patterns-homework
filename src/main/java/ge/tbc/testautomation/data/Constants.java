...
public class Constants extends CommonPage {
    ...
    //public static final String DEVCRAFT_UI_ELEMENT = "//h5[text()='DevCraft UI']";
    ...
    public static final String DEVCRAFT_COMPLATE = "DevCraft Complete";
    public static final String One_instance_With_fifteen = "1 instance with 15 users";
    public static final String PRIORITY_SUPPORT = "Priority Support";
    public static final String REACT_PRICE = "999";
    public static final String UI_PRICE = "1,149";
